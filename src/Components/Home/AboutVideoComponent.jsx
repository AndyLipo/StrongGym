        ...
        <div className="relative w-full h-[400px] sm:h-[500px] md:h-[600px]">
            ...
            <div className="absolute inset-0 flex items-center px-4 sm:px-8 md:px-12 lg:px-16">
                <div className="text-center md:text-left w-full md:w-auto">
                    ...
                    <h2 className="text-sm sm:text-base md:text-lg text-zinc-300 max-w-md sm:max-w-xl mb-2 sm:mb-3 mx-auto md:mx-0">
                        Transformamos vidas a través del fitness
                    </h2>
                    <h3 className="text-xs sm:text-sm md:text-base text-zinc-300 max-w-xs sm:max-w-sm mx-auto md:mx-0 leading-relaxed">
